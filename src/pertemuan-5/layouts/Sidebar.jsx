...
export default function Sidebar() {
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            Sedap <span id="logo-dot" className="text-hijau font-bold">.</span>
            </span>

                <span id="logo-subtitle" className="font-semibold font-barlow text-gray-400">Modern Admin Dashboard</span>
            </div>
